...
@section('content')
    ...
    <div class="topbar">
        <div>
            ...
            <p class="topbar-subtitle">Create a new product category</p>
        </div>
            ...
            <div class="form-group">
                ...
                <div
                    ...
                    <div
                        ...
                        <i id="icon-preview" class="fa fa-tag" style="color:#a5b4fc; font-size:22px;"></i>
                    </div>
                    <p style="font-size:13px; color:var(--text-muted);">Icon will be auto-generated based on category name.
                    </p>
                </div>
            </div>

            <button type="submit" class="btn-submit" style="background:linear-gradient(135deg,#6366f1,#4f46e5);">
                <span class="btn-text">Create Category &nbsp;<i class="fa fa-layer-group"></i></span>
