...
<div class="topbar">
    <div>
        <h1 class="topbar-title">Add Address</h1>
        <p class="topbar-subtitle">Add a new delivery address</p>
    </div>
...
<div class="card" style="padding:32px; max-width:560px; margin:0 auto;">
    ...
    <form method="POST" action="{{ route('buyer.addresses.store') }}">
        ...
        <button type="submit" class="btn-submit" style="background:linear-gradient(135deg,#6366f1,#4f46e5);">
            <span class="btn-text">Save Address &nbsp;<i class="fa fa-location-dot"></i></span>
