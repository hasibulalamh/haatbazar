...
<head>
    ...
    <title>HaatBazar — Seller Login</title>
...
<div class="auth-wrapper">
    <div class="auth-card card">
        ...
        <p class="auth-subtitle">Login to your seller account</p>
        ...
        <form method="POST" action="{{ route('seller.login.store') }}">
            ...
            <div class="form-group">
                <div style="display:flex; justify-content:space-between; align-items:center; margin-bottom:8px;">
                    ...
                    <a href="#" style="font-size:12px; color:#fcd34d;">Forgot password?</a>
                </div>
                <div class="input-wrapper">
        ...
        <div class="auth-links">
            <p>Don't have an account? <a href="{{ route('seller.register') }}" style="color:#fcd34d;">Register here</a></p>
            <a href="{{ route('buyer.login') }}" class="buyer-link">
                <i class="fa fa-bag-shopping" style="color:var(--primary-light);"></i>
                <span>Login as Buyer instead</span>
